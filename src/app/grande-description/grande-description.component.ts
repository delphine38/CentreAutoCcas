...
export class GrandeDescriptionComponent implements OnInit {
  ...
  voiture = new Voiture("nenenen","Audi A1","Très belle Audi A3, peu rouler, confort cuir de vachette, couleur camel. Electrique /110 000km. Boite automatique pour confort de conduite optimisé. Palette au volant, tableau de bord intuitif. Bluetooth. Possibilité de discution de prix à l'essai.","30 000", "2020", "120 000", "Audi", "A1", "Electrique","AudiA1");
